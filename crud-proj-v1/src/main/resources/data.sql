...
INSERT INTO CLIENTE (nome_completo, email, telefone, fk_endereco) VALUES
('Roberta Souza', 'roberta.souza@email.com', '11998877665', 2);
-- CLIENTE ID: 1

INSERT INTO CATEGORIA (descricao) VALUES ('Calçados');
-- CATEGORIA ID: 1

INSERT INTO PRODUTO (modelo, marca, tamanho, cor, preco_custo, fk_categoria) VALUES
...
---------------------------------------------------
INSERT INTO FUNCIONARIO (nome, cpf, email, salario, comissao)
VALUES ('Ana Vendedora', '123.456.789-00', 'ana.vendas@empresa.com', 2000.00, 0.05);
...
INSERT INTO VENDA (data_hora, valor_total, forma_pagamento, fk_cliente, fk_vendedor)
VALUES
('2025-09-26 12:30:00', 599.98, 'PIX', 1, 1); -- fk_vendedor = 1
-- VENDA ID: 1

-- VENDA 2: Compra de Sapatos (159.50 + 99.00 = 258.50)
INSERT INTO VENDA (data_hora, valor_total, forma_pagamento, fk_cliente, fk_vendedor)
VALUES
('2025-09-26 14:00:00', 258.50, 'Cartão de Débito', 1, 1); -- fk_vendedor = 1
-- VENDA ID: 2
