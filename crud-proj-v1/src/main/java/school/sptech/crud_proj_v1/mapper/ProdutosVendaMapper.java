...
public class ProdutosVendaMapper {
    ...
    public static ProdutosVendaResponseDTO toProdutosVendaResponseDTO(ProdutosVenda itemVenda) {
        if (itemVenda == null) {
            return null;
        }
    ...
    public static List<ProdutosVendaResponseDTO> toProdutosVendaResponseDTO(List<ProdutosVenda> itens) {
        if (itens == null) {
            return List.of();
        }
        return itens.stream()
