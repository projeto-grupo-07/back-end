...
public class VendaRequestDTO {
    ...
    @Schema(description = "Esse campo representa a foreign key do cliente relacionado à venda", example = "1")
    ...
    public VendaRequestDTO(Integer idVendedor, Integer idCliente, FormaDePagamento formaPagamento, List<VendaProdutoRequestDTO> itensVenda) {
